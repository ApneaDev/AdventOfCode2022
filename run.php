...
use ApneaDev\AoC22\lib\Bootstrap\Bootstrap;
...
$input = Collection::createFromStream((new StreamFactory())->createStreamFromFile('src/AoC22/Day'.$day.'/input.txt'));

$runnerClass = 'ApneaDev\AoC22\Day'.$day.'\Runner';
